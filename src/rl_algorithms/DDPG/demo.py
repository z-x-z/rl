...
Description  : 
Author       : CagedBird
Date         : 2021-08-20 20:24:14
FilePath     : /rl/src/rl_algorithms/DDPG/demo.py
torch = 0.41
原文链接：https://blog.csdn.net/blanokvaffy/article/details/86232658
'''
import random
import os
...
class ANet(nn.Module):  # ae(s)=a
    def __init__(self, s_dim, a_dim):
        ...
        self.fc1 = nn.Linear(s_dim, HIDDEN_LAYERS)
        self.fc1.weight.data.normal_(0, 0.1)  # initialization
        self.out = nn.Linear(HIDDEN_LAYERS, a_dim)
...
class CNet(nn.Module):  # ae(s)=a
    def __init__(self, s_dim, a_dim):
        ...
        self.fcs = nn.Linear(s_dim, HIDDEN_LAYERS)
        self.fcs.weight.data.normal_(0, 0.1)  # initialization
        self.fca = nn.Linear(a_dim, HIDDEN_LAYERS)
        self.fca.weight.data.normal_(0, 0.1)  # initialization
        self.out = nn.Linear(HIDDEN_LAYERS, 1)
        self.out.weight.data.normal_(0, 0.1)  # initialization
