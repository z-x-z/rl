...
class TD:
    def __init__(self, env, max_episodes, learning_rate=0.5, discount=1.0, epsilon=0.1, moving_average_interval=20):
        self.env = env
...
class TDCartPole(TD):
    def __init__(self, env, max_episodes, learning_rate=0.5, discount=1.0, epsilon=0.1, n_bins=10):
        super().__init__(env, max_episodes, learning_rate, discount, epsilon)
