...
from src.rl_algorithms.TD_n.TD_N import TD_N_CartPole


class TD_N_CartPole_QLearning(TD_N_CartPole):
...
if __name__ == "__main__":
    ...
    n = 5
    episode_nums = 200
    q_learning = TD_N_CartPole_QLearning(n, env, episode_nums)
    Q, record = q_learning.run()
    # plot record
    TD_N_CartPole.draw_record(record)
